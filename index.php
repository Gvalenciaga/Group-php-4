          ...
          <form action="book.php" method="POST" >
            ...
            <div class="form-row ">
              ...
              <div class="form-group col-lg-4">
                ...
                <select name="doctorsname" class="form-control wide" id="inputDoctorName">
                  ...
                  <option value="Guga Kuzanovi ">Guga Kuzanovi</option>
                  <option value="Vitali Daraselia ">Vitali Daraselia</option>
                </select>
              </div>
              <div class="form-group col-lg-4">
            ...
            <div class="form-row ">
              <div class="form-group col-lg-4">
                ...
                <input type="number" name="phonenum" class="form-control" id="inputPhone" placeholder="XXXXXXXXXX">
              </div>
              <div class="form-group col-lg-4">
